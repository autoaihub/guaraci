...
def test_autogenerated_path_source_marks_path_param_required() -> None:
    ...
    # O identificador não carrega as chaves do caminho: `{codigo_cnes}` no
    # nome obrigaria o usuário a escapá-lo no shell.
    schema = service.get_source_schema("cnes_estabelecimentos_por_codigo_cnes")
    specs = {item["name"]: item for item in schema["params"]}
