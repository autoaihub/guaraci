...
- **Papel do README**: O `README.md` age como a porta de entrada. Ele DEVE refletir estritamente a versão `tag` atual de produção do repositório (atualmente `0.4.1`) e documentar as features presentes nela. Não deve conter promessas de backlog futuro tratadas como já prontas.
